...
- Linux CI/cargo-dist dependencies now include the WebKitGTK 4.1 / JavaScriptCoreGTK 4.1 development packages required by Tauri v2, avoiding `javascriptcoregtk-4.1.pc` build failures during clippy/build.
