...
pub(in super::super) fn config_station_member_editor_from_member(
...
pub(in super::super) struct StationsSectionArgs<'a> {
    pub lang: Language,
...
pub(in super::super) fn render_config_v2_stations_section(
    ui: &mut egui::Ui,
