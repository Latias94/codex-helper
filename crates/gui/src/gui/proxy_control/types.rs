...
pub(super) struct AttachedRefreshResult {
    ...
    pub(super) session_route_target: HashMap<String, String>,
    ...
    pub(super) supports_session_route_target_override: bool,
    pub(super) supports_global_route_target_override: bool,
...
pub struct AttachedStatus {
    ...
    pub recent: Arc<[FinishedRequest]>,
    ...
    pub supports_session_route_target_override: bool,
    ...
    pub supports_runtime_shutdown_api: bool,
...
impl AttachedStatus {
    pub(super) fn new(port: u16) -> Self {
        Self {
            ...
            supports_runtime_shutdown_api: false,
