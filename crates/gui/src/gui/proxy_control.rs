...
use crate::dashboard_core::{
    OperatorRetrySummary, WindowStats, summarize_recent_retry_observations,
};
...
impl ProxyController {
    ...
    pub fn snapshot(&self) -> Option<GuiRuntimeSnapshot> {
        match &self.mode {
            ProxyMode::Running(r) => {
                let route_graph_routing = r
                    .cfg
                    .version
                    .is_some_and(crate::config::is_supported_route_graph_config_version);
                let station_runtime_override_supported =
                    !matches!(r.cfg.version, Some(3)) && !route_graph_routing;
                Some(GuiRuntimeSnapshot {
                    ...
                    global_route_target_override: r.global_route_target_override.clone(),
                    ...
                    session_route_target_overrides: r.session_route_target_overrides.clone(),
                    ...
                    routing_explain: r.routing_explain.clone(),
                    supports_routing_explain_api: true,
                    operator_retry_summary: Some(local_operator_retry_summary(r)),
                    supports_pricing_catalog_api: true,
                    ...
                    supports_station_runtime_override: station_runtime_override_supported,
            ...
            ProxyMode::Attached(a) => Some(GuiRuntimeSnapshot {
                ...
                global_route_target_override: a.global_route_target_override.clone(),
                ...
                session_route_target_overrides: a.session_route_target_overrides.clone(),
                ...
                provider_balances: a.provider_balances.clone(),
                stats_5m: a.stats_5m.clone(),
                stats_1h: a.stats_1h.clone(),
                pricing_catalog: a.pricing_catalog.clone(),
                routing_explain: a.routing_explain.clone(),
                supports_routing_explain_api: a.supports_routing_explain_api,
                operator_retry_summary: a.operator_retry_summary.clone(),
                supports_pricing_catalog_api: a.supports_pricing_catalog_api,
