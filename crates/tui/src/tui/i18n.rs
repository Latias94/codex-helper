...
define_messages! {
    ...
    FOOTER_STATS => { zh: "1-8 页面  q 退出  L 语言  Tab 焦点  ↑/↓ 选择  a 关注  g 刷新余额  PgUp/PgDn 详情  ? 帮助", en: "1-8 pages  q quit  L language  Tab focus  ↑/↓ select  a attention  g refresh balances  PgUp/PgDn detail  ? help" },
