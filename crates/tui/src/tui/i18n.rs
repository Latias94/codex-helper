...
define_messages! {
    ...
    STATS_FOCUS_STATIONS => { zh: "站点", en: "stations" },
    ...
    FOOTER_STATS => { zh: "1-9/0 页面  q 退出  L 语言  Tab 池/项目/提供商/站点  ↑/↓ 选择  g 刷新  y 报告  ? 帮助", en: "1-9/0 pages  q quit  L language  Tab pool/project/provider/station  ↑/↓ select  g refresh  y report  ? help" },
