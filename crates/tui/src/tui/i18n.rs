...
define_messages! {
    ...
    PAGE_FLEET => { zh: "9 Fleet", en: "9 Fleet" },
    ...
    FOOTER_DASHBOARD => { zh: "1-9 页面  q 退出  L 语言  Tab 焦点  ↑/↓ 移动  b/M/f 覆盖  p/P 站点  ? 帮助", en: "1-9 pages  q quit  L language  Tab focus  ↑/↓ move  b/M/f overrides  p/P station  ? help" },
    FOOTER_DASHBOARD_ROUTE_GRAPH => { zh: "1-9 页面  q 退出  L 语言  Tab 焦点  ↑/↓ 移动  b/M/f 覆盖  p/P 路由  ? 帮助", en: "1-9 pages  q quit  L language  Tab focus  ↑/↓ move  b/M/f overrides  p/P route  ? help" },
    FOOTER_ROUTING => { zh: "1-9 页面  q 退出  L 语言  ↑/↓ provider  r/Enter 编辑  g 刷新余额  ? 帮助", en: "1-9 pages  q quit  L language  ↑/↓ provider  r/Enter edit  g refresh balances  ? help" },
    FOOTER_STATIONS => { zh: "1-9 页面  q 退出  L 语言  ↑/↓ 选择  Enter pin  i 详情  h/H 检查  ? 帮助", en: "1-9 pages  q quit  L language  ↑/↓ select  Enter pin  i details  h/H check  ? help" },
    FOOTER_REQUESTS => { zh: "1-9 页面  q 退出  L 语言  ↑/↓ 选择  e 错误  s scope  o/h 跳转  ? 帮助", en: "1-9 pages  q quit  L language  ↑/↓ select  e errors  s scope  o/h navigate  ? help" },
    FOOTER_SESSIONS => { zh: "1-9 页面  q 退出  L 语言  ↑/↓ 选择  b/M/f 覆盖  a/e/v 筛选  t 记录  ? 帮助", en: "1-9 pages  q quit  L language  ↑/↓ select  b/M/f overrides  a/e/v filters  t transcript  ? help" },
    FOOTER_STATS => { zh: "1-9 页面  q 退出  L 语言  Tab 站点/提供商  ↑/↓ 选择  a 关注  g 刷新余额  PgUp/PgDn 详情  ? 帮助", en: "1-9 pages  q quit  L language  Tab station/provider  ↑/↓ select  a attention  g refresh balances  PgUp/PgDn detail  ? help" },
    FOOTER_SETTINGS_CODEX => { zh: "1-9 页面  q 退出  L 语言  p/P profile  R 重载  O 导入  B/I/F/V/D patch  C 诊断  ? 帮助", en: "1-9 pages  q quit  L language  p/P profile  R reload  O import  B/I/F/V/D patch  C diagnose  ? help" },
    FOOTER_SETTINGS_OTHER => { zh: "1-9 页面  q 退出  L 语言  p/P profile  R 重载  ? 帮助", en: "1-9 pages  q quit  L language  p/P profile  R reload  ? help" },
    FOOTER_HISTORY => { zh: "1-9 页面  q 退出  L 语言  ↑/↓ 选择  r 刷新  t/Enter 记录  s/f 跳转  ? 帮助", en: "1-9 pages  q quit  L language  ↑/↓ select  r refresh  t/Enter transcript  s/f navigate  ? help" },
    FOOTER_RECENT => { zh: "1-9 页面  q 退出  L 语言  ↑/↓ 选择  [] 时间  Enter/y 复制  t 记录  s/f/h 跳转  ? 帮助", en: "1-9 pages  q quit  L language  ↑/↓ select  [] window  Enter/y copy  t transcript  s/f/h navigate  ? help" },
    FOOTER_FLEET => { zh: "1-9 页面  q 退出  L 语言  Tab 视图  ↑/↓ 选择  ? 帮助", en: "1-9 pages  q quit  L language  Tab view  ↑/↓ select  ? help" },
    ...
    COMMON_KEYS_CODEX => { zh: "  1-9 切页  ? 帮助  q 退出  L 语言  (Stations: i 详情  Usage: y 导出/复制  Settings: R 重载  O 覆盖导入  C 诊断  B/I/F/V/D patch)", en: "  1-9 pages  ? help  q quit  L language  (Stations: i details  Usage: y export/copy  Settings: R reload  O overwrite  C diagnose  B/I/F/V/D patch)" },
    COMMON_KEYS_OTHER => { zh: "  1-9 切页  ? 帮助  q 退出  L 语言  (Stations: i 详情  Usage: y 导出/复制)", en: "  1-9 pages  ? help  q quit  L language  (Stations: i details  Usage: y export/copy)" },
