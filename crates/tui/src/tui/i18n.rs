...
define_messages! {
    ...
    FOOTER_STATS => { zh: "1-8 页面  q 退出  L 语言  Tab 焦点  ↑/↓ 选择  PgUp/PgDn 详情  d 窗口  a 关注项  g 刷新余额  y 报告  ? 帮助", en: "1-8 pages  q quit  L language  Tab focus  ↑/↓ select  PgUp/PgDn detail  d window  a attention  g refresh balances  y report  ? help" },
