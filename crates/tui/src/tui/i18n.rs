...
define_messages! {
    ...
    COMMON_KEYS_CODEX => { zh: "  1-8 切页  ? 帮助  q 退出  L 语言  (Stations: i 详情  Stats: y 导出/复制  Settings: R 重载  O 覆盖导入  C 诊断  B/I/F/V/D patch)", en: "  1-8 pages  ? help  q quit  L language  (Stations: i details  Stats: y export/copy  Settings: R reload  O overwrite  C diagnose  B/I/F/V/D patch)" },
