...
define_messages! {
    ...
    PAGE_SERVICE_STATUS => { zh: "5 状态", en: "5 Status" },
    PAGE_STATS => { zh: "6 用量", en: "6 Usage" },
    ...
    FOOTER_STATS => { zh: "1-9/0 页面  q 退出  L 语言  Tab 站点/提供商  ↑/↓ 选择  a 关注  g 刷新余额  PgUp/PgDn 详情  ? 帮助", en: "1-9/0 pages  q quit  L language  Tab station/provider  ↑/↓ select  a attention  g refresh balances  PgUp/PgDn detail  ? help" },
