...
define_messages! {
    ...
    FOOTER_ROUTING => { zh: "1-9/0 页面  q 退出  ↑/↓/Pg 端点  s 首选  Enter 操作  a 自动  m 模式  g 刷新  i 详情  ? 帮助", en: "1-9/0 pages  q quit  ↑/↓/Pg endpoint  s prefer  Enter actions  a auto  m mode  g refresh  i details  ? help" },
