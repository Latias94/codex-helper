import { AlertTriangle, ChevronDown, Copy, FolderOpen, RefreshCw, Settings2 } from "lucide-react";
    ...
    <>
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <SettingsCard title="关于与路径" description="版本、本机路径和更新信息。">
          ...
          <PathRow label="Config" value="~/.codex-helper/config.toml" />
          <PathRow label="Logs" value="~/.codex-helper/logs" />
          <PathRow label="Cache" value="~/.codex-helper/cache" />
          <div className="flex gap-2 pt-2">
