...
P6 status: v4 runtime compatibility config is now derived from a compatibility
`RoutePlanTemplate`; `compile_v4_to_v2` remains for migration and compatibility
